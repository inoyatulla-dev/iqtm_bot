...
const uz: Dict = {
  ...
  "settings.topics.routingHint": "Har bir voqea turi qaysi mavzuga xabar yuborishini tanlang. Bo'lim uchun mavzu belgilangan bo'lsa — vazifaga oid xabarlarda u ustunlik qiladi.",
  "settings.topics.routeDefault": "— Asosiy guruh",
...
const ru: Dict = {
  ...
  "settings.topics.routingHint": "Выберите, в какую тему отправлять уведомления каждого типа. Если у отдела задана тема — для уведомлений по задачам она в приоритете.",
  "settings.topics.routeDefault": "— Основная группа",
...
const en: Dict = {
  ...
  "settings.topics.routingHint": "Choose which topic each event type should be sent to. If a department has its own topic, it takes priority for task notifications.",
  "settings.topics.routeDefault": "— Main group",
